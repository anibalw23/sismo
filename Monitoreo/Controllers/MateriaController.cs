    ...
    public class MateriaController : BaseController
    {
        ...
        public JsonResult GetDataJson(DatatablesParams values)
        {
            ...
            if (values.search != null && values.search.ContainsKey("value") && values.search["value"] is string[])
            {
                ...
                {
                    data = data.Where(x => 
                        x.nombreMateria.Contains(searchValue)
                    );
                ...
                foreach (var item in values.order)
                {
                    ...
                    switch (sortBy)
                    {
                        case "nombreMateria":
                            ...
                            {
                                data = data.OrderByDescending(s => s.nombreMateria);
                            }
                            else
                            {
                                data = data.OrderBy(s => s.nombreMateria);
                            }
                            sorting = true;
                            break;
                    }
        ...
        public ActionResult Create([Bind(Include="ID,nombreMateria,esBasica,esTecnica")] Materia materia)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include="ID,nombreMateria,esBasica,esTecnica")] Materia materia)
        {
            if (ModelState.IsValid)
            {
